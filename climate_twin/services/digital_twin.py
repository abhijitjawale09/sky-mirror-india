...
class DigitalTwinEngine:
    ...
    def get_dashboard_state(
        ...
        return {
            ...
            "all_feature_importances": self.forecaster.get_all_feature_importances(),
            "best_models": self.forecaster.get_best_models(),
            "trained_model_names": self.forecaster.get_model_names(),
            "active_model": self.forecaster.active_model_name,
            "scorecard": scorecard,
